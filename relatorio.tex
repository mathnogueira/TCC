...
\usepackage[colorlinks=true,
            ...
            citecolor=rltgreen,
            pdftitle={Relatório de estágio de Matheus Henrique Nogueira de Paula},
          pdfauthor={Matheus Henrique Nogueira de Paula},
...
\title{Desenvolvimento de um módulo de análise para o Sistema de Outorga do estado do Rio Grande do Sul}
...
\defesa{30 de Fevereiro de 2017}
%==============================================================================
%##################################################
...
%\folhaAprovacaoAssinada{images/folharosto}
...
\dedic{Dedico à minha familia. Em especial, aos meus pais, Maria e Paulo}     % Dedicatórias\\
...
\input{tex/local_estagio}
\input{tex/atividades}
\input{tex/elementos}
\input{tex/conclusao}
...
\referencias
\bibliography{tex/refbib}			% arquivo exemplo refbib.bib
%==============================================================================
